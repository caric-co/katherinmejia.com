...
const recommendation = [
  {
    scale: "Inicio (10-50 usuarios)",
    rec: "Bunny Stream + DRM Básico",
    detail: "$5-18/mes. Sin desarrollo adicional para infraestructura de video.",
  },
  {
    scale: "Escala (100-500)",
    rec: "Continuar con Bunny Stream",
    detail: "$35-170/mes. Evaluar Red de Volumen si la cobertura LATAM es aceptable.",
  },
  {
    scale: "Escala (1.000+)",
    rec: "Evaluar híbrido",
    detail:
      "Bunny para DRM/reproductor/codificación con R2 como almacenamiento origen. A $339/mes, Bunny sigue siendo razonable.",
  },
  {
    scale: "Transmisión en vivo",
    rec: "Bunny Stream Live",
    detail: "Ingesta RTMP (compatible OBS), codificación estándar gratis, solo costo de ancho de banda CDN.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <h1 className="font-display text-h1 tracking-tight mb-3">Costos de Video Streaming y Almacenamiento</h1>
        <p className="text-muted-foreground mb-8 max-w-3xl">
          Análisis comparativo de proveedores de video para la plataforma de cursos de KMakeup. Enfoque en audiencia
          latinoamericana (Colombia) con escala de 10 a 1.000+ usuarios.
        </p>
        ...
        <div className="border border-accent bg-accent/20 p-5 mb-12">
          ...
          <p className="text-muted-foreground">
            Contenido almacenado: ~50 horas (3.000 minutos, ~150 GB tras codificación multi-bitrate) · Consumo promedio
            por usuario: 3 horas/mes (180 min, ~7,5 GB) · Resolución máxima: 1080p · Región principal: América del Sur
            (Colombia)
          </p>
        </div>

        {/* Comparison tables */}
        <h2 className="font-display text-h2 mb-4">Comparativa de Costos Mensuales (USD, sin DRM)</h2>
            ...
            <TableBody>
              {noDrmData.map((row) => (
                <TableRow key={row.users}>
                  ...
                  <TableCell className={row.best === "bunny" ? "bg-accent/30 font-semibold" : ""}>
                    {row.bunny}
                  </TableCell>
        ...
        <h2 className="font-display text-h2 mb-4">Comparativa con DRM</h2>
        <Separator className="mb-4" />
        <div className="mb-12">
          <Table>
            <TableHeader>
        ...
        <h2 className="font-display text-h2 mb-4">Detalle por Proveedor</h2>
        <Separator className="mb-4" />
        ...
        {/* Optimization */}
        <h2 className="font-display text-h2 mb-4">Estrategias de Optimización de Costos</h2>
        <Separator className="mb-4" />
        ...
        {/* Recommendation */}
        <h2 className="font-display text-h2 mb-4">Recomendación para KMakeup</h2>
        <Separator className="mb-4" />
