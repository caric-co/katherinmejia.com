...
const services = [
  {
    name: "Vercel",
    desc: "Alojamiento",
    detail: "$20/mes (Plan Pro, requerido para uso comercial)",
    sub: "Incluye 1 TB de ancho de banda, CI/CD, previews. Suficiente hasta ~10.000 usuarios.",
  },
  {
    name: "Convex",
    desc: "Backend",
    detail: "$0 hasta ~440 usuarios (1M llamadas gratis/mes)",
    sub: "Pro a $25/mes cubre hasta 25M llamadas. Se estiman ~2.250 llamadas/usuario/mes.",
  },
  {
    name: "Bunny Stream",
    desc: "Video",
    detail: "Principal generador de costo. $0,045/GB en Sudamérica.",
    sub: "150 GB almacenados ($1,50/mes) + ~7,5 GB/usuario/mes de ancho de banda. DRM básico gratis.",
  },
  {
    name: "UploadThing",
    desc: "Archivos",
    detail: "$0 hasta 2 GB (miniaturas, portadas, portafolio)",
    sub: "$10/mes por 100 GB si se excede. Suficiente gratis hasta ~5.000 usuarios.",
  },
  {
    name: "Resend",
    desc: "Correo",
    detail: "$0 hasta 3.000 correos/mes (~2.000 usuarios)",
    sub: "$20/mes para 50.000 correos. Se estiman ~1,4 correos/usuario/mes.",
  },
  {
    name: "Otros",
    desc: "Auth, Analytics, AI",
    detail: "Better Auth: $0 · PostHog: $0 hasta 1M eventos/mes · Sentry: $0 hasta 5K errores/mes",
    sub: "Mistral API: ~$0,01/mes (negligible) · Dominio: $1/mes (~$12/año)",
  },
];
...
const revenueTable = [
  ...
  {
    users: "25.000",
    revenue: "$1.692.750.000",
    platform: "$5.213.300",
    bold: "$55.183.700",
    total: "$60.397.000",
    profit: "$1.632.353.000",
    margin: "96,4%",
    divider: true,
  },
  {
    users: "50.000",
    revenue: "$3.385.500.000",
    platform: "$10.966.800",
    bold: "$110.367.300",
    total: "$121.334.100",
    profit: "$3.264.165.900",
    margin: "96,4%",
  },
  {
    users: "100.000",
    revenue: "$6.771.000.000",
    platform: "$20.468.400",
    bold: "$220.734.600",
    total: "$241.203.000",
    profit: "$6.529.797.000",
    margin: "96,4%",
  },
  {
    users: "250.000",
    revenue: "$16.927.500.000",
    platform: "$53.191.200",
    bold: "$551.836.500",
    total: "$605.027.700",
    profit: "$16.322.472.300",
    margin: "96,4%",
  },
  {
    users: "500.000",
    revenue: "$33.855.000.000",
    platform: "$103.696.200",
    bold: "$1.103.673.000",
    total: "$1.207.369.200",
    profit: "$32.647.630.800",
    margin: "96,4%",
  },
  {
    users: "1.000.000",
    revenue: "$67.710.000.000",
    platform: "$207.296.200",
    bold: "$2.207.346.000",
    total: "$2.414.642.200",
    profit: "$65.295.357.800",
    margin: "96,4%",
  },
];
...
const freeTiers = [
  ...
  {
    service: "UploadThing",
    limit: "2 GB almacenamiento",
    exceeds: "~5.000 usuarios (con fotos de perfil)",
    cost: "$10/mes",
  },
...
const milestones = [
  ...
  {
    users: "~10.000-25.000",
    event: "Punto de inflexión de Bunny",
    action: "Migrar a Red de Volumen ($0,005/GB)",
    impact: "-80% en video",
    highlight: true,
  },
  {
    users: "~100.000+",
    event: "Escala enterprise",
    action: "Negociar contratos con todos los proveedores",
    impact: "Reducción 20-40%",
  },
];
    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <p className="text-muted-foreground mb-10 max-w-3xl">
          Desglose completo de costos operativos mensuales por servicio y escala de usuarios, con modelo de precios
          recomendado para alcanzar 50-80% de margen de ganancia en pesos colombianos. TRM: $3.700.
        </p>
          ...
          {services.map((s) => (
            <div key={s.name} className="bg-muted p-5">
              <h3 className="font-semibold">
                {s.name} <span className="font-normal text-muted-foreground text-sm">{s.desc}</span>
              </h3>
              <p className="mt-1">
                <strong>{s.detail.split(".")[0]}.</strong>
              </p>
          ...
          <Table>
            ...
            <TableBody>
              {costTable.map((row) => (
                <TableRow
                  key={row.users}
                  className={row.highlight ? "bg-accent/20" : row.divider ? "border-t-2 border-foreground/20" : ""}
                >
        ...
        <p className="text-xs text-muted-foreground mb-12">
          A partir de 25K, Bunny migra a Red de Volumen ($0,005/GB plano), reduciendo el costo de video ~9x.
        </p>
        ...
        <p className="text-muted-foreground mb-6">
          Precios posicionados para el mercado colombiano de cursos de maquillaje. Por debajo de academias premium
          ($300-500K COP) pero por encima de cursos masivos tipo Domestika ($37-111K COP).
        </p>
        ...
        <p className="text-muted-foreground mb-4">
          Supuestos: 60% suscriptores mensuales, 25% anuales, 15% compradores individuales. Ingreso promedio ponderado:{" "}
          <strong>$18,30 USD/mes ($67.710 COP/mes)</strong>.
        </p>
        <div className="mb-4">
          <Table>
            <TableHeader>
        ...
        <p className="text-xs text-muted-foreground mb-12">
          Valores en COP. Comisión Bold.co: mezcla 70% tarjeta (2,89% + $900 COP) / 30% Nequi (1,50%). Tasa efectiva
          ~3,26%.
        </p>
        ...
        <div className="border border-accent bg-accent/20 p-5 mb-12">
          <p className="text-muted-foreground">
            <strong className="text-foreground">Hasta ~440 usuarios</strong>, el único costo fijo es Vercel ($20/mes) +
            Bunny Stream (variable) + dominio ($1/mes). Con 50 usuarios el costo total es apenas ~$39 USD/mes (~$144.300
            COP), generando ~$3.130.800 COP de ganancia mensual.
          </p>
        </div>
