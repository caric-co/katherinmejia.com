...
const columns: ColumnDef<QuoteFeature>[] = [
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Horas Est." className="justify-center" />
    ),
    cell: ({ row }) => (
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Complejidad" className="justify-center" />
    ),
    cell: ({ row }) => {
