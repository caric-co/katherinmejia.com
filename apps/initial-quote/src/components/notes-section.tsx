export function NotesSection() {
  return (
    <section className="mb-12">
      <h2 className="text-2xl font-normal mb-6">Notas y Consideraciones</h2>
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-lg border border-border p-4 bg-card">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            video. Consulte el estudio detallado en la documentación.
          </p>
        </div>
        ...
        <div className="rounded-lg border border-border p-4 bg-card">
          ...
          <p className="text-sm text-muted-foreground">
            ...
            infraestructura de Convex. Esta aproximación evita dependencias
