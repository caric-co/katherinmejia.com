...
export function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center pt-14 bg-background">
      <div className="max-w-7xl mx-auto px-6 md:px-10 w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        {/* Text */}
        ...
        {/* Image */}
        <div
          className="aspect-[4/5] bg-accent/20 bg-cover bg-center"
          style={{
            backgroundImage:
