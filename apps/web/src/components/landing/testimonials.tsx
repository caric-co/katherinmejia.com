...
const defaults = [
  {
    ...
    textFallback: "Los cursos de Katherin transformaron mi manera de maquillarme. Las técnicas son claras y los resultados son increíbles.",
  },
  {
    nameKey: "testimonials.2.name",
    nameFallback: "Laura Rodríguez",
    textKey: "testimonials.2.text",
    textFallback: "Aprendí más en un curso de Katherin que en años intentando por mi cuenta. Su método es práctico y directo.",
  },
  {
    nameKey: "testimonials.3.name",
    nameFallback: "Camila Torres",
    textKey: "testimonials.3.text",
    textFallback: "El maquillaje para mi boda quedó espectacular. Katherin entiende exactamente lo que necesitas y lo ejecuta a la perfección.",
  },
]
