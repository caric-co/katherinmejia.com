  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <h1 className="font-display text-h2 tracking-tight mb-2 text-center">Crear cuenta</h1>
        <p className="text-muted-foreground text-center mb-8">Regístrate para acceder a los cursos de maquillaje</p>
